            ...
            <div class="row">
                <div class="central" id="test">
                    <div class="info-test">
						...
						<?php 
						if (isset($_GET['summ'])) {
    echo "ТЕСТ ПРОЙДЕН!</h2><div> <p style=\"color:black\">  Вы набрали </p> <h2> ".$_GET['summ']." баллов </h2></div>";
} 
  ?>    
                        <p style="color:black">  
                            Для дальнейшего работы вам необходимо зарегистрироваться
                        </p>
                    </div>
                    <a class="btn-blue"  style="color:white"  href="../auth.php">Зарегестрироваться!</a>
                </div>
